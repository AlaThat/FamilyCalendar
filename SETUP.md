...
- **Shopping list** — its own tab: add items with a quick text box, check them off when you get them at the store. Unlike routines/chores/reminders, items don't reset or disappear on their own — an item stays on the list, unchecked, for as long as it takes until someone actually checks it off; checked items show with a strikethrough and sink to the bottom rather than vanishing immediately, so an accidental tap doesn't lose anything.
